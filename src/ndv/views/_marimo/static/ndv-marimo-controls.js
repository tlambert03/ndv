 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Br, defineProperty: Pr, getOwnPropertyDescriptor: Fr, getOwnPropertyNames: Ir, getOwnPropertySymbols: Hr, getPrototypeOf: Nr } = Object, mo = globalThis, va = mo.trustedTypes, Ur = va ? va.emptyScript : "", ze = mo.reactiveElementPolyfillSupport, Qo = (o, e) => o, ve = { toAttribute(o, e) {
  switch (e) {
    case Boolean:
      o = o ? Ur : null;
      break;
...
let Vo = class extends HTMLElement {
  ...
  static createProperty(e, a = fa) {
    if (a.state && (a.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(e) && ((a = Object.create(a)).wrapped = !0), this.elementProperties.set(e, a), !a.noAccessor) {
      ...
      t !== void 0 && Pr(this.prototype, e, t);
    }
  }
  static getPropertyDescriptor(e, a, r) {
    const { get: t, set: l } = Fr(this.prototype, e) ?? { get() {
      return this[a];
    }, set(n) {
      this[a] = n;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(Qo("properties"))) {
      const a = this.properties, r = [...Ir(a), ...Hr(a)];
...
\f\r]`, Yo = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ba = /-->/g, ya = />/g, So = RegExp(`>|${Ee}(?:([^\\s"'>=/]+)(${Ee}*=${Ee}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), xa = /'/g, ka = /"/g, Ka = /^(?:script|style|textarea|title)$/i, Kr = (o) => (e, ...a) => ({ _$litType$: o, strings: e, values: a }), m = Kr(1), F = Symbol.for("lit-noChange"), A = Symbol.for("lit-nothing"), Ca = /* @__PURE__ */ new WeakMap(), Lo = Ro.createTreeWalker(Ro, 129);
function Ya(o, e) {
...
const Yr = (o, e) => {
  ...
  for (let i = 0; i < a; i++) {
    const c = o[i];
    let w, d, h = -1, p = 0;
    for (; p < c.length && (n.lastIndex = p, d = n.exec(c), d !== null); ) p = n.lastIndex, n === Yo ? d[1] === "!--" ? n = ba : d[1] !== void 0 ? n = ya : d[2] !== void 0 ? (Ka.test(d[2]) && (t = RegExp("</" + d[2], "g")), n = So) : d[3] !== void 0 && (n = So) : n === So ? d[0] === ">" ? (n = t ?? Yo, h = -1) : d[1] === void 0 ? h = -2 : (h = n.lastIndex - d[2].length, w = d[1], n = d[3] === void 0 ? So : d[3] === '"' ? ka : xa) : n === ka || n === xa ? n = So : n === ba || n === ya ? n = Yo : (n = So, t = void 0);
    const v = n === So && o[i + 1].startsWith("/>") ? " " : "";
...
function Fo(o, e, a = o, r) {
  var n, i;
  if (e === F) return e;
  let t = r !== void 0 ? (n = a._$Co) == null ? void 0 : n[r] : a._$Cl;
  const l = ee(e) ? void 0 : e._$litDirective$;
  return (t == null ? void 0 : t.constructor) !== l && ((i = t == null ? void 0 : t._$AO) == null || i.call(t, !1), l === void 0 ? t = void 0 : (t = new l(o), t._$AT(o, a, r)), r !== void 0 ? (a._$Co ?? (a._$Co = []))[r] = t : a._$Cl = t), t !== void 0 && (e = Fo(o, t._$AS(o, e.values), t, r)), e;
}
class Xr {
  constructor(e, a) {
...
class No {
  ...
  _$AI(e, a = this) {
    e = Fo(this, e, a), ee(e) ? e === A || e == null || e === "" ? (this._$AH !== A && this._$AR(), this._$AH = A) : e !== this._$AH && e !== F && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Wr(e) ? this.k(e) : this._(e);
  }
  O(e) {
...
class xe {
  ...
  _$AI(e, a = this, r, t) {
    ...
    let n = !1;
    if (l === void 0) e = Fo(this, e, a, 0), n = !ee(e) || e !== this._$AH && e !== F, n && (this._$AH = e);
    else {
      const i = e;
      let c, w;
      for (e = l[0], c = 0; c < l.length - 1; c++) w = Fo(this, i[r + c], a, c), w === F && (w = this._$AH[c]), n || (n = !ee(w) || w !== this._$AH[c]), w === A ? e = A : e !== A && (e += (w ?? "") + l[c + 1]), this._$AH[c] = w;
    }
    n && !t && this.j(e);
  }
  j(e) {
...
var Ha;
lo._$litElement$ = !0, lo.finalized = !0, (Ha = To.litElementHydrateSupport) == null || Ha.call(To, { LitElement: lo });
const Le = To.litElementPolyfillSupport;
Le == null || Le({ LitElement: lo });
(To.litElementVersions ?? (To.litElementVersions = [])).push("4.2.2");
/**
 * @license
...
/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */
var Te = typeof window < "u" && "ontouchstart" in window, se = class {
  constructor(o, e) {
  ...
  start() {
    this.isActive || (this.element.addEventListener("pointerdown", this.handleDragStart), Te && this.element.addEventListener("touchstart", this.handleDragStart), this.isActive = !0);
  }
  /** Stop listening to drags. */
  stop() {
    document.removeEventListener("pointerup", this.handleDragStop), document.removeEventListener("pointermove", this.handleDragMove), document.removeEventListener("pointercancel", this.handleDragStop), document.removeEventListener("touchend", this.handleDragStop), document.removeEventListener("touchmove", this.handleDragMove), document.removeEventListener("touchcancel", this.handleDragStop), this.element.removeEventListener("pointerdown", this.handleDragStart), Te && this.element.removeEventListener("touchstart", this.handleDragStart), this.isActive = !1, this.isDragging = !1;
  }
...
var xt = () => ({
  ...
  get value() {
    if (this.valueHasChanged) {
      ...
      return P(e, this.min, this.max);
    }
    const o = this._value ?? this.defaultValue;
    return P(o, this.min, this.max);
  }
  set value(o) {
  ...
  updated(o) {
    if (o.has("range") && this.requestUpdate(), this.isRange ? (o.has("minValue") || o.has("maxValue")) && (this.minValue = P(this.minValue, this.min, this.maxValue), this.maxValue = P(this.maxValue, this.minValue, this.max), this.updateFormValue()) : o.has("value") && this.setValue(String(this.value)), (o.has("min") || o.has("max")) && this.isRange && (this.minValue = P(this.minValue, this.min, this.max), this.maxValue = P(this.maxValue, this.min, this.max)), o.has("disabled") && this.customStates.set("disabled", this.disabled), o.has("disabled") || o.has("readonly")) {
  ...
  clampAndRoundToStep(o) {
    ...
    return o = Math.round(o / a) * a, o = P(o, r, t), parseFloat(o.toFixed(e));
  }
  ...
  handleKeyDown(o) {
    ...
    t !== r && (this.isRange ? (this.activeThumb === "min" ? t > this.maxValue ? (this.maxValue = t, this.minValue = t) : this.minValue = Math.max(this.min, t) : t < this.minValue ? (this.minValue = t, this.maxValue = t) : this.maxValue = Math.min(this.max, t), this.updateFormValue()) : this.value = P(t, this.min, this.max), this.updateComplete.then(() => {
  ...
  stepDown() {
    if (this.isRange) {
      ...
      this.minValue = P(o, this.min, this.maxValue), this.updateFormValue();
    } else {
  ...
  stepUp() {
    if (this.isRange) {
      ...
      this.maxValue = P(o, this.minValue, this.max), this.updateFormValue();
    } else {
      const o = this.clampAndRoundToStep(this.value + this.step);
      this.value = o;
    }
    ...
    `, w = this.withMarkers ? m`
      ...
      (p) => m`<span part="marker" class="marker" style=${Do({ "--position": `${p}%` })}></span>`
        ...
        ` : "", h = (p, v) => this.withTooltip ? m`
          ...
          ` : "";
    if (this.isRange) {
      const p = P(this.getPercentageFromValue(this.minValue), 0, 100), v = P(this.getPercentageFromValue(this.maxValue), 0, 100);
      return m`
        ${i}
      ...
      const p = P(this.getPercentageFromValue(this.value), 0, 100), v = P(
...
const $a = ["left", "right"], _a = ["right", "left"], Et = ["top", "bottom"], At = ["bottom", "top"];
function Lt(o, e, a) {
  switch (o) {
    case "top":
    case "bottom":
      return a ? e ? _a : $a : e ? $a : _a;
    case "left":
    case "right":
      return e ? Et : At;
    default:
...
async function Rt(o, e) {
  ...
  } : n.reference, _ = await (l.getOffsetParent == null ? void 0 : l.getOffsetParent(i.floating)), E = await (l.isElement == null ? void 0 : l.isElement(_)) ? await (l.getScale == null ? void 0 : l.getScale(_)) || {
    x: 1,
    y: 1
  } : {
    x: 1,
...
const Mt = 50, qt = async (o, e, a) => {
  ...
  for (let g = 0; g < l.length; g++) {
    ...
    d = _ ?? d, h = E ?? h, f[b] = {
      ...f[b],
      ...M
    }, T && v < Mt && (v++, typeof T == "object" && (T.placement && (p = T.placement), T.rects && (w = T.rects === !0 ? await n.getElementRects({
      reference: o,
      floating: e,
      strategy: t
    }) : T.rects), {
  ...
  async fn(e) {
    ...
    const h = lr(d), p = {
      x: a,
      y: r
    }, v = ta(t), f = ra(v), g = await n.getDimensions(w), y = v === "y", b = y ? "top" : "left", C = y ? "bottom" : "right", _ = y ? "clientHeight" : "clientWidth", E = l.reference[f] + l.reference[v] - p[v] - l.floating[f], M = p[v] - l.reference[v], T = await (n.getOffsetParent == null ? void 0 : n.getOffsetParent(w));
    let q = T ? T[_] : 0;
    (!q || !await (n.isElement == null ? void 0 : n.isElement(T))) && (q = i.floating[_] || l.floating[f]);
    const co = E / 2 - M / 2, ao = q / 2 - g[f] / 2 - 1, W = bo(h[b], ao), po = bo(h[C], ao), ro = W, vo = q - g[f] - po, V = q / 2 - g[f] / 2 + co, _o = Ne(ro, V, vo), wo = !c.arrow && Wo(t) != null && V !== _o && l.reference[f] / 2 - (V < ro ? W : po) - g[f] / 2 < 0, G = wo ? V < ro ? V - ro : V - vo : 0;
    return {
      [v]: p[v] + G,
      data: {
        [v]: _o,
  ...
  return o === void 0 && (o = {}), {
    ...
    async fn(e) {
      ...
      if ((a = l.arrow) != null && a.alignmentOffset)
        return {};
      const b = yo(t), C = uo(i), _ = yo(i) === i, E = await (c.isRTL == null ? void 0 : c.isRTL(w.floating)), M = p || (_ || !g ? [me(i)] : zt(i)), T = f !== "none";
      !p && T && M.push(...Tt(i, g, f, E));
      ...
      if (W = [...W, {
        ...
        var po, ro;
        const V = (((po = l.flip) == null ? void 0 : po.index) || 0) + 1, _o = q[V];
        if (_o && (!(h === "alignment" ? C !== uo(_o) : !1) || // We leave the current main axis only if every placement on that axis
...
const Ft = function(o) {
  ...
  return o === void 0 && (o = {}), {
    ...
    async fn(e) {
      ...
      let f = d[v], g = d[p];
      if (n) {
        const b = v === "y" ? "top" : "left", C = v === "y" ? "bottom" : "right", _ = f + h[b], E = f - h[C];
        f = Ne(_, f, E);
      }
      if (i) {
        const b = p === "y" ? "top" : "left", C = p === "y" ? "bottom" : "right", _ = g + h[b], E = g - h[C];
        g = Ne(_, g, E);
      }
      const y = c.fn({
        ...e,
  ...
  return o === void 0 && (o = {}), {
    ...
    async fn(e) {
      ...
      const C = g - d.top - d.bottom, _ = f - d.left - d.right, E = bo(g - d[y], C), M = bo(f - d[b], _), T = !e.middlewareData.shift;
      let q = E, co = M;
      if ((a = e.middlewareData.shift) != null && a.enabled.x && (co = _), (r = e.middlewareData.shift) != null && r.enabled.y && (q = C), T && !p) {
...
function ir(o) {
  const e = xo(o);
  return Io(e) ? o.ownerDocument ? o.ownerDocument.body : o.body : ho(e) && ie(e) ? e : ir(e);
}
function Ho(o, e, a) {
  var r;
...
function Mo(o, e, a, r) {
  ...
  if (l) {
    ...
    let f = p, g = je(f);
    for (; g && r && v !== f; ) {
      const y = Po(g), b = g.getBoundingClientRect(), C = oo(g), _ = b.left + (g.clientLeft + parseFloat(C.paddingLeft)) * y.x, E = b.top + (g.clientTop + parseFloat(C.paddingTop)) * y.y;
      c *= y.x, w *= y.y, d *= y.x, h *= y.y, c += _, w += E, f = N(g), g = je(f);
    }
  }
  return be({
    width: d,
...
function Se(o, e) {
  const a = _e(o).scrollLeft;
  return e ? e.left + a : Mo(so(o)).left + a;
}
function wr(o, e) {
  const a = o.getBoundingClientRect(), r = a.left + e.scrollLeft - Se(o, a), t = a.top + e.scrollTop;
  return {
    x: r,
    y: t
  };
...
function Xt(o) {
  ...
  const d = no(0), h = ho(r);
  if ((h || !h && !l) && ((Ko(r) !== "body" || ie(n)) && (c = _e(r)), h)) {
    const v = Mo(r);
    w = Po(r), d.x = v.x + r.clientLeft, d.y = v.y + r.clientTop;
  }
...
function Gt(o) {
  const e = so(o), a = _e(o), r = o.ownerDocument.body, t = H(e.scrollWidth, e.clientWidth, r.scrollWidth, r.clientWidth), l = H(e.scrollHeight, e.clientHeight, r.scrollHeight, r.clientHeight);
  let n = -a.scrollLeft + Se(o);
  const i = -a.scrollTop;
...
function Jt(o, e) {
  const a = Mo(o, !0, e === "fixed"), r = a.top + o.clientTop, t = a.left + o.clientLeft, l = ho(o) ? Po(o) : no(1), n = o.clientWidth * l.x, i = o.clientHeight * l.y, c = t * l.x, w = r * l.y;
  return {
    width: n,
    height: i,
    x: c,
...
function dr(o, e) {
  const a = xo(o);
  return a === e || !J(a) || Io(a) ? !1 : oo(a).position === "fixed" || dr(a, e);
}
function ol(o, e) {
  const a = e.get(o);
  if (a)
...
function ur(o, e) {
  ...
  for (; r && Nt(r) && Re(r); )
    r = La(r, e);
  return r && Io(r) && Re(r) && !$e(r) ? a : r || Wt(o) || a;
}
...
function nl(o, e) {
  ...
  function n(i, c) {
    ...
    if (i || e(), !p || !v)
      return;
    const f = ce(h), g = ce(t.clientWidth - (d + p)), y = ce(t.clientHeight - (h + v)), b = ce(d), _ = {
    ...
    try {
      ...
      a = new IntersectionObserver(M, _);
    }
    a.observe(o);
  }
  return n(!0), l;
...
const vr = Ft, fr = It, gr = Vt, Ta = Ht, il = Dt, mr = (o, e, a) => {
...
var Na, we = (Na = globalThis == null ? void 0 : globalThis.HTMLElement) == null ? void 0 : Na.prototype.hasOwnProperty("popover"), S = class extends Z {
  constructor() {
  ...
  async handleAnchorChange() {
    ...
    } else this.anchor instanceof Element || Oa(this.anchor) ? this.anchorEl = this.anchor : this.anchorEl = this.querySelector('[slot="anchor"]');
  ...
  reposition() {
    ...
    let e;
    we && !Oa(this.anchor) && this.boundary === "scroll" && (e = Ho(this.anchorEl).filter((r) => r instanceof Element)), this.flip && o.push(
      gr({
...
function ua(o) {
  return Oo.length > 0 && Oo[Oo.length - 1] === o;
}
/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */
function ye(o, e) {
...
function zl() {
  if (!Ye) {
    ...
    o && Sl(o.getAttribute("data-fa-kit-code") || "");
  }
  return Ye;
}
/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: Pl } = ot, Da = (o) => o, Fl = (o, e) => (o == null ? void 0 : o._$litType$) !== void 0, Il = (o) => o.strings === void 0, Va = () => document.createComment(""), Xo = (o, e, a) => {
  var l;
  const r = o._$AA.parentNode, t = e === void 0 ? o._$AB : e._$AA;
  if (a === void 0) {
    const n = r.insertBefore(Va(), t), i = r.insertBefore(Va(), t);
    a = new Pl(n, i, o, o.options);
  } else {
...
/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */
var Zo = Symbol(), de = Symbol(), Pe, Fe = /* @__PURE__ */ new Map(), R = class extends Z {
  constructor() {
    super(...arguments), this.svg = null, this.autoWidth = !1, this.swapOpacity = !1, this.label = "", this.library = "default", this.rotate = 0, this.resolveIcon = async (o, e) => {
      ...
      try {
        ...
        Pe || (Pe = new DOMParser());
        const i = Pe.parseFromString(l.outerHTML, "text/html").body.querySelector("svg");
  ...
  async setIcon() {
    ...
    let r = Fe.get(o);
    r || (r = this.resolveIcon(o, a), Fe.set(o, r));
    const t = await r;
    t === de && Fe.delete(o);
    ...
    if (o === l.url) {
      ...
      switch (t) {
        ...
        case Zo:
          ...
          break;
        default:
          this.svg = t.cloneNode(!0), (n = a == null ? void 0 : a.mutator) == null || n.call(a, this.svg, this), this.dispatchEvent(new _l());
      }
    }
  }
  updated(o) {
...
const Ba = le(class extends ne {
  constructor(o) {
    ...
    if (!Il(o)) throw Error("`live` bindings can only contain a single expression");
  }
  render(o) {
    return o;
  }
  update(o, [e]) {
    ...
    if (o.type === to.PROPERTY) {
      ...
      if (!!e === a.hasAttribute(r)) return F;
    } else if (o.type === to.ATTRIBUTE && a.getAttribute(r) === e + "") return F;
    return kr(o), e;
  }
});
/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */
...
], O.prototype, "handleDefaultCheckedChange", 1);
s([
  j(["checked", "indeterminate"])
], O.prototype, "handleStateChange", 1);
s([
  j("disabled")
...
var Ie = /* @__PURE__ */ new Set(), I = class extends Z {
  constructor() {
  ...
  async showMenu() {
    ...
    if (this.popup.active)
      return;
    Ie.forEach((r) => r.open = !1), this.popup.active = !0, this.open = !0, Ie.add(this), da(this), this.syncAriaAttributes(), document.addEventListener("keydown", this.handleDocumentKeyDown), document.addEventListener("pointerdown", this.handleDocumentPointerDown), document.addEventListener("mousemove", this.handleGlobalMouseMove), this.menu.classList.remove("hide"), await ko(this.menu, "show");
  ...
  async hideMenu() {
    ...
    this.open = !1, Ie.delete(this), re(this), this.syncAriaAttributes(), document.removeEventListener("keydown", this.handleDocumentKeyDown), document.removeEventListener("pointerdown", this.handleDocumentPointerDown), document.removeEventListener("mousemove", this.handleGlobalMouseMove), this.menu.classList.remove("show"), await ko(this.menu, "hide"), this.popup.active = this.open, this.dispatchEvent(new ca());
  }
  ...
  setupSubmenuPosition(o) {
    ...
    a && (a.removeEventListener("slotchange", I.handleSubmenuSlotChange), a.addEventListener("slotchange", I.handleSubmenuSlotChange), I.handleSubmenuSlotChange({ target: a }));
  }
...
const Pa = (o, e, a) => {
  ...
  update(o, [e, a, r]) {
    ...
    else if (w === void 0 && (w = Pa(n, v, f), d = Pa(i, h, p)), w.has(i[h])) if (w.has(i[p])) {
...
class _r extends lo {
  ...
  constructor() {
    super(), this.sliders = [], this.model = null, this._dragging = /* @__PURE__ */ new Set(), this._playing = /* @__PURE__ */ new Map();
  }
  _onSliderInput(e, a) {
  ...
  _togglePlay(e) {
    this._playing.has(e.axis) ? this._stopPlay(e.axis) : this._startPlay(e), this.requestUpdate();
  }
  _startPlay(e, a = 20) {
    const r = this._playing.get(e.axis);
    r && clearInterval(r.intervalId);
    const t = performance.now(), l = e.value, n = e.max - e.min + 1, i = Math.max(1, Math.floor(1e3 / a / 2)), c = setInterval(() => {
      const w = (performance.now() - t) / 1e3, d = e.min + (l - e.min + Math.floor(w * a)) % n;
    ...
    this._playing.set(e.axis, { intervalId: c, fps: a });
  }
  _stopPlay(e) {
    const a = this._playing.get(e);
    a && (clearInterval(a.intervalId), this._playing.delete(e));
  }
  _onFpsChange(e, a) {
    const r = parseFloat(e.target.value) || 20;
    this._playing.has(a.axis) && this._startPlay(a, r), this.requestUpdate();
  }
  disconnectedCallback() {
  ...
  render() {
    return m`
      ...
      (e) => e.axis,
      (e) => {
        const a = this._playing.has(e.axis);
        return m`
            <div class="ndv-slider-row ${e.visible ? "" : "ndv-hidden"}">
              <wa-button
                size="small"
                appearance=${a ? "filled" : "plain"}
                class="ndv-play-btn"
                @click=${() => this._togglePlay(e)}
                title="Play/Pause"
              >
                ${a ? "⏸" : "▶"}
              </wa-button>
              ...
              <wa-slider
                ...
                step=${e.step}
                with-tooltip
                @input=${(r) => this._onSliderInput(r, e)}
                @change=${(r) => this._onSliderChange(r, e)}
              ></wa-slider>
...
customElements.get("ndv-dim-sliders") || customElements.define("ndv-dim-sliders", _r);
class Sr extends lo {
  createRenderRoot() {
    return this;
  }
  constructor() {
    super(), this.lut = {}, this.model = null, this.showHistogramButton = !0, this._showPercentilePopup = !1;
  }
  _sendLutUpdate(e) {
    this.model && (this.model.set("_js_event", {
      type: "update_lut",
  ...
  _onAutoContextMenu(e) {
    if (e.preventDefault(), e.stopPropagation(), e.stopImmediatePropagation(), this._showPercentilePopup = !this._showPercentilePopup, this._showPercentilePopup) {
      const r = e.currentTarget.getBoundingClientRect();
      this._popupRight = window.innerWidth - r.right, this._popupBottom = window.innerHeight - r.top + 4;
    }
  }
    ...
    return !e || !e.key ? m`` : m`
      ...
      ${this._showPercentilePopup ? m`
            ...
            >
              <label>
                ...
                <input
                  ...
                  max="100"
                  step="0.1"
                  .value=${String(e.auto_lower_tail || 0)}
              ...
              <label>
                ...
                <input
                  ...
                  max="100"
                  step="0.1"
                  .value=${String(e.auto_upper_tail || 0)}
            ...
            <div
              ...
              @click=${() => this._showPercentilePopup = !1}
            ></div>
          ` : ""}
    `;
  }
...
qo(Sr, "properties", {
  ...
  _showPercentilePopup: { state: !0 }
});
customElements.get("ndv-lut-row") || customElements.define("ndv-lut-row", Sr);
class zr extends lo {
  createRenderRoot() {
    return this;
  }
...
function Xl(o) {
  ...
  if (r.setAttribute("data-ndv-controls-style", ""), r.textContent = Fa, a.appendChild(r), a !== document.head && !Ia) {
    const t = document.createElement("style");
    t.setAttribute("data-ndv-controls-style", ""), t.textContent = Fa, document.head.appendChild(t), Ia = !0;
  }
}
